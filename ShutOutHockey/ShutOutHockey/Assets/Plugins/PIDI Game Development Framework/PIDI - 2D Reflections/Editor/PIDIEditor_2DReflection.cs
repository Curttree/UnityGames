...
public class PIDIEditor_2DReflection : Editor {
	...
	public override void OnInspectorGUI(){
        ...
        if ( mTarget.srpMode ){
            ...
            EditorGUILayout.HelpBox("SRPs are a new rendering system introduced by Unity in newer versions. It is still in development and support for this pipeline is still in Beta. Make sure you import all the required libraries to unity before enabling SRP support", MessageType.Info);
        ...
        GUILayout.Label("PIDI - 2D Reflections©. Version 1.2", tempStyle );
